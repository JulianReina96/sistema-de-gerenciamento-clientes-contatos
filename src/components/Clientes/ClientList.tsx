            ...
            return (
              ...
              >
                <div className="flex items-start justify-between">
                  {/* Avatar (primeiro elemento à esquerda). usa foto_url se existir, senão fallback estático.
                      w-16 h-16 para ocupar o espaço do cartão colapsado; flex-shrink-0 evita encolhimento. */}
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="text-xl font-semibold text-gray-800 mb-2 truncate" title={client.full_name}>
                        {client.full_name}
                      </h3>

                      <div className="space-y-2 text-sm">
                        <div>
                          <span className="font-medium text-gray-600">Data de Registro:</span>
                ...
                {/* Detalhes adicionais (único local onde e-mails/telefones aparecem) */}
                {isExpanded && (
